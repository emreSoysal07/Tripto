...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
  ...
  <div class="app-brand demo">
    <a href="{{ route('admin.dashboard') }}" class="app-brand-link">
      ...
      <span class="app-brand-text demo menu-text fw-bolder ms-2">Tripto</span>
    </a>
  ...
  <ul class="menu-inner py-1">
    ...
    <li class="menu-item {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
      <a href="{{ route('admin.dashboard') }}" class="menu-link">
        ...
        <div data-i18n="Dashboard">Kontrol Paneli</div>
      </a>
    </li>

    <!-- MÜLK & İLAN YÖNETİMİ -->
    <li class="menu-header small text-uppercase">
      <span class="menu-header-text">Mülk Yönetimi</span>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('admin.properties.*') ? 'active' : '' }}">
      <a href="{{ route('admin.properties.index') }}" class="menu-link">
        ...
        <div data-i18n="Properties">Mülkler</div>
      </a>
    </li>

    <!-- Property Types -->
    <li class="menu-item {{ request()->routeIs('admin.property-types.*') ? 'active' : '' }}">
      <a href="{{ route('admin.property-types.index') }}" class="menu-link">
        <i class="menu-icon tf-icons bx bx-category"></i>
        <div data-i18n="Property Types">Mülk Tipleri</div>
      </a>
    </li>
    ...
    <li class="menu-item {{ request()->routeIs('admin.amenities.*') ? 'active' : '' }}">
      <a href="{{ route('admin.amenities.index') }}" class="menu-link">
        ...
        <div data-i18n="Amenities">Olanaklar</div>
      </a>
    </li>
